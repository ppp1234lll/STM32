...
//	strcat((char*)data,"VER=11;");
	...
	sprintf((char*)str,"RELAY=%01d,%01d,%01d,%01d,%01d,%01d,%01d,%01d;",
											...
											relay_get_status(RELAY_5),relay_get_status(RELAY_6),
											relay_get_status(RELAY_7),relay_get_status(RELAY_8));
	strcat((char*)data,(char*)str);
	...
	sprintf((char*)str,"CHV=%s,%s,%s,%s,%s,%s,%s,%s;",
	...
	sprintf((char*)str,"CHA=%s,%s,%s,%s,%s,%s,%s,%s;",
											str_buff[0],str_buff[1],str_buff[2],str_buff[3],
											str_buff[4],str_buff[5],str_buff[6],str_buff[7]);
	strcat((char*)data,(char*)str);
	...
	sprintf((char*)str,"ELEC=%s,%s,%s,%s,%s,%s,%s,%s;",
											str_buff[0],str_buff[1],str_buff[2],str_buff[3],
											str_buff[4],str_buff[5],str_buff[6],str_buff[7]);
	strcat((char*)data,(char*)str);
