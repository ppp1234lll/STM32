...
//uint8_t update_status_detcet_function(void);

void update_set_update_mode(uint8_t mode);
uint8_t update_get_mode_function(void);
//void save_stroage_update_infor_function(save_param_t param);
//void save_read_update_infor_function(save_param_t *param);
...
int8_t DNS_domain_name_resolution(void);
void OTA_DNS_serverFound(const char *name, struct ip_addr *ipaddr, void *arg);
